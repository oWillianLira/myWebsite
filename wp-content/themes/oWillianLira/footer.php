<?php $general = get_page_by_title('General Data')->ID; ?>
        ...
        <div class="row  align-items-center  justify-content-between">
            ...
            <div class="col-lg-4 col-sm-6">
                <ul class="linksFooter">
                    <li>
                        <a class="icon dark" href="mailto:<?php the_field2('email', $general); ?>" title="Meu Gmail" target="_blank">
                            <div>
                    ...
                    <li>
                        <a class="icon" href="<?php the_field2('linkedin', $general); ?>" title="Meu LinkedIn" target="_blank">
                            <div>
                    ...
                    <li>
                        <a class="icon" href="<?php the_field2('git', $general); ?>" title="Meu GitHub" target="_blank">
                            <div>
                    ...
                    <li>
                        <a class="icon" href="<?php the_field2('instagram', $general); ?>" title="Meu Instagram" target="_blank">
                            <div>
