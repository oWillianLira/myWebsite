<footer class="sects" id="footer_owl">
    <div class="container">
        <div class="row  align-items-center  justify-content-between">
            ...
            <div class="col-lg-4 col-sm-6">
                <ul class="linksFooter">
                    <li>
                        <a class="icon dark" href="mailto:owillianlira@gmail.com" title="Meu Gmail" target="_blank">
                            <div>
                            ...
                            owillianlira@gmail.com
                        </a>
                    </li>
                    <li>
                        <a class="icon" href="https://linkedin.com/in/owillianlira" title="Meu LinkedIn" target="_blank">
                            <div>
                            ...
                            linkedin.com/in/owillianlira
                        </a>
                    </li>
                    <li>
                        <a class="icon" href="https://github.com/oWillianLira" title="Meu GitHub" target="_blank">
                            <div>
                            ...
                            github.com/oWillianLira
                        </a>
                    </li>
                    <li>
                        <a class="icon" href="https://instagram.com/owillianlira" title="Meu Instagram" target="_blank">
                            <div>
            ...
            <div class="col-lg-3 col-sm-4">
                <div class="imgFooter">
                    <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2020/09/euMoji.png" alt="Eu me despedindo" title="EuMoji">
                </div>
            </div>
        </div>
    </div>
...
<div id="copyrigths">
    <div class="container">
        <span>&copy; <strong>Willian Lira</strong> 2020 — Alguns direitos reservados</span>
    </div>
</div>
