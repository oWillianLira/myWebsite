...
<div id="banner_owl-cv" class="banner_owl" style="background-image: url(<?php echo get_home_url(); ?>/wp-content/uploads/2020/09/bg_cover2.jpg);">
    <div class="container">
        ...
        <div class="links">
            <a class="dark" href="mailto:<?php the_field2('email', $general); ?>" title="Meu Gmail" target="_blank">
            ...
            <a href="<?php the_field2('linkedin', $general); ?>" title="Meu LinkedIn" target="_blank">
            ...
            <a href="<?php the_field2('git', $general); ?>" title="Meu GitHub" target="_blank">
            ...
            <a href="<?php the_field2('instagram', $general); ?>" title="Meu Instagram" target="_blank">
