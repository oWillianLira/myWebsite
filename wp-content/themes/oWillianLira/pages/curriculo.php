...
<div id="banner_owl-cv" class="banner_owl" style="background-image: url(<?php echo get_home_url(); ?>/wp-content/uploads/2020/09/bg_cover2.jpg);">
    <div class="container">
...
<section class="sects" id="cv">
    <div class="container">
        <div class="cv_intro">
            <h2>Willian dos Santos Lira</h2>
            <p>Brasileiro — <span id="age">22</span> anos</p>
            <p><strong>Endereço:</strong> Rua Durval, nº 102 - Jardim Eusônia, Guarulhos/SP (CEP: 07050-280)</p>
            <p><strong>Contatos:</strong> <a class="dark" target="_blank" href="tel:+5511949099792">(11) 94909-9792</a> — <a class="dark" target="_blank" href="mailto:owillianlira@gmail.com">owillianlira@gmail.com</a></p>

            <div class="abstract">
                <div class="title"><h3>Resumo</h3></div>
                <div class="box">
                    <p>Atualmente sou desenvolvedor Front-End, gosto muito do que faço e me sinto sempre inspirado a estudar e me aprofundar mais em desenvolvimento no geral. Em cada projeto novo me esforço ao máximo, para superar as expectativas e continuar evoluindo como profissional.</p>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="cv_infos">
                    <div class="item">
                        <div class="img">
                            <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2020/09/graduation.png" title="">
                        </div>
                        <div class="txt">
                    ...
                    <div class="item">
                        <div class="img">
                            <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2020/09/english.png" title="">
                        </div>
                        <div class="txt">
                            <h4>Idiomas</h4>
                            <p>
                    ...
                    <div class="item">
                        <div class="img">
                            <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2020/09/workXP.png" title="">
                        </div>
                        <div class="txt">
